...
{
	$M['SELF_VERSION']='������ �����';
	$M['SELF_VERSION_DESC']='����� ������� �� ������: <a href="http://www.1c-bitrix.ru/download/scripts/bitrix_server_test.php">http://www.1c-bitrix.ru/download/scripts/bitrix_server_test.php</a>';
	$M['SELF_OLD']='��������';
	$M['SELF_NEW']='����������';
	$M['TITLE']='������-���� "�������: ���������� ������"';
	$M['TOP_MSG']='<font class="install">������-���� </font>&nbsp;<font class="bitrixtitle">&quot;�������: ���������� ������&quot;</font>';
	$M['TOP_DESC']='������������ ��������� ������������ �������, ����������� ��� ������������� ���� ������������ ������������ �������� "�������: ���������� ������"';
	$M['TOP_SELECT_TYPE']='�������� ���������� ������������ ������� ���: ';
	$M['TOP_TAR1']='������ ������';
	$M['TOP_TAR2']='������ &quot;�������&quot;';
	$M['TOP_LINKS']='
						<a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=32&CHAPTER_ID=1139">������� ���� ��� ��������</a><br>
						<a href="http://partners.1c-bitrix.ru/program/hosting.php">���������� �� ������������ ��������</a><br>
						<a href="http://partners.1c-bitrix.ru/program/hosting.php#tab-requirements-link">���������� �� ���������� ��������</a>';
	$M['START_TEST']='������ ������������';
	$M['CONF_GENERAL']='����� ������������';
	$M['CONF_FS']='�������� �������';
	$M['SENDFILE']="��������� ����";
	...
	$M['CONF_ADD']='�������������� ����������';
	$M['OPEN']='�������';
	$M['COPY']='&nbsp;&copy; &laquo;�������&raquo;, 2001-';
	$M['SUPPORT_LINK']='<a href="http://www.bitrixsoft.ru">www.bitrixsoft.ru</a>  |  <a href="http://www.bitrixsoft.ru/support/">������������</a>';
	$M['OPEN_RESULT']='������� ��������� �����';
	$M['LIMIT']='�����:';
	$M['TESTING']='���������...';
	$M['DEL_TMP_TABLE']="�������� �������� �������";
	...
	$M['NA']="�� ����������";
	$M['WEB_SERVER']="������ ���-�������";
	$M['WEB_SERVER_DESC']="��������� Apache 1.3.0 � ���� ��� IIS 5.0 � ����";
	$M['SAPI']="��������� php";
	$M['SAPI_DESC']="������������� ��������� PHP ��� ������ Apache, ��� ������� ��� CGI � ��� ����� ������ ���������";
	$M['PHP_VER']="������ php";
	$M['PHP_VER_DESC']='��������� 5.6 � ����, ������������� 7.1';
	$M['SAFE_DESC']="����� safe_mode �� ��������������";
	$M['TEST_SESS']="���������� ������";
	$M['TEST_SESS_DESC']='���������� ��� ���������� �����������';
	$M['TEST_SESS_UA']="���������� ������ ��� UserAgent";
	$M['TEST_SESS_UA_DESC']='���������� ��� ������� ������������� �������� ������ � ������ � 1�';
	$M['SHORT_TAG']="�������� short_open_tag";
	$M['SHORT_TAG_DESC']='short_open_tag=off �� ��������������';
	$M['MEM_LIMIT']="�������� memory_limit";
	$M['MEM_LIMIT_DESC']='����������� ������ ������ ���� �� ���� 32 �� (64 �� ��� ������� �������� ������� � "��������"). �������������� PHP ������ � php.ini ���������� ��������� ����� ��������� ������ ������, ��������� ��� ����������.';
	$M['MEM_FACT']="����������� ����������� ������";
	$M['MEM_FACT_DESC']='������ ����������� ����������� ������ ����� ���������� �� ��������� php';
	$M['SENDMAIL']="�������� �����";
	$M['SENDMAIL_DESC']='������� ������� ������� mail()';
	$M['MCRYPT_TEST']='������ ����������';
	$M['HASH_TEST']='������ Hash';
	$M['MCRYPT_TEST_DESC']='��������� ���������� ����������� � ������';
	$M['SOCK_TEST']="������� ������ � ��������";
	$M['SOCK_TEST_DESC']='���������� ��� ������ ������� ����������';
	$M['SYSUPDATE']="������� ����������";
	$M['SYSUPDATE_DESC']='�������������� ������� ������������ � ������� www.bitrixsoft.ru �� ���� 80';
	$M['NO_CONNECT']="��� �����������";
	$M['HTTP_AUTH']="HTTP �����������";
	$M['1C_1']='��������� ��� ����������� � 1� � MS Outlook. ����������� � <b>';
	$M['1C_2']='</b> �� <b>';
	$M['1C_3']='</b> ����';
	$M['SET_TM']="��������� set_time_limit";
	$M['SET_TM_DESC']='��� �������� ���������� �������� � ������ ������� ������������� ��������� ���������� ��������� max_execution_time ����� ������� set_time_limit �� ��������.';
	$M['TIME_TEST']="���� �� �����";
	$M['TIME_TEST_CPU']="���� �� ����� � ��������� �� ���������";
	$M['TIME_TEST_CPU_DESC']="� ���� ������� ������� ����������� ��� ���������� �������� �� ���������";
	$M['TIME_TEST_DESC']='������� ��������� ������ � ������� 60 ������';
	$M['PHP_ACC']="����������� php";
	$M['PHP_ACC_DESC']='������������� ������� ������������ PHP (APC, XCache ��� ������ ������� ����� ����������� EAccelerator), ��� ��������� ������� �������� �� CPU � ��������� ��� � ��������� ����� ���������� PHP ����. ����������, ����� ������ ������������ ���� ���������� ��� ���������� ���� ����� ������������ PHP �������. ������������� ���������� �������, �������� (��� eA): eaccelerator.filter  !*/help/* !*/admin/* !*/bitrix/*cache/* */bitrix/* */.*.php<br>���� ����������� �� ���������, ��������� ������ <a href="?phpinfo=Y">phpinfo()</a>';
	$M['CONFLICT']='��������';
	$M['NOT_FOUND']='�� ���������';
	$M['D_SPACE']="����� �� �����";
	$M['D_SPACE_DESC']='�� ����� 50 �� ��� �������� "�����" � �� ����� 150 �� ��� �������� "������"';
	$M['F_PERM']="����� �� ������� �����";
	$M['F_CREATE']="�������� �����";
	$M['F_CREATE_DESC']='������� ������� �������� �����';
	$M['F_NEW_PERM']="����� �� ��������� �����";
	...
	$M['HTACCESS']="��������� .htaccess";
	$M['HTACCESS_D']='�������������� ������� ��������� ��������� 404-� ������ �� ����� ��������� �����';
	$M['FILE_UPL']="�������� file_uploads";
	$M['FILE_UPL_TEST']="�������� �����";
	$M['FILE_UPL_TEST_D']='�������� �������� �������� � ������� GIF';
	$M['IMG']="�����������";
	$M['IMG_D']='��� �������� �������� ������������ ��������';
	$M['EREGS']="���������� ��������� PHP";
	$M['PREG']="���������� ��������� Perl";
	...
	$M['DB_CONNECT']="����������� � ������� MySQL";
	$M['MYSQL_TEST']="������������ MySQL";
	$M['SQL_MODE_DESC']='������ `STRICT*` �� ��������������';
	$M['DB_HOST']="���� ��";
	$M['DB_NAME']="��� ��";
	$M['DB_USER']="������������";
	$M['DB_PASS']="������";
	$M['SHOW_ERR']="�������� �������";
	$M['SHOW_ERR_D']='�������� ����������� ������ � ����� ��� ���� <a href="bitrix_server_test.log" target="_blank">bitrix_server_test.log</a>';
	$M['POST_MS']="�������� post_max_size";
	$M['ERROR']='������';
	$M['YES']="��";
	$M['NO']="���";
	$M['TIME']="�����";
	...
	$M['FS_TIME_D']="���������� ����� - �� 2 ������";
	$M['SEC']="���.";
	$M['SECURE_DBCONN']="���� ���� ������������ dbconn.php, �� �������� �� ������������ � ����� ������������";
	$M["LOADER_LOAD_CANT_OPEN_WRITE"] = "�� ���� ������� ���� #FILE# �� ������";
	$M["LOADER_NEW_VERSION"] = "�������� ����� ������ ������� ������������, �� ��������� � �� �������";
	$M["max_input_vars"] = "������ ���� �� ������ 10000";
}
							...
							<tr>
								<td colspan=2 width="100%" height="619" valign="top" align="left" bgcolor="#DCE9F2">
									<div style="padding:20px;">
										...
										{
											$res = 'Zend Accelerator <a href="http://dev.1c-bitrix.ru/community/blogs/howto/the-problem-of-performance-in-version-12.php" target=_blank>���� ��������</a>';
											$val = false;
										}
	...
	?>';
		...
		<input type=hidden name='test' value=\"".htmlspecialchars(@$_REQUEST['test'])."\">";
										...
										if ($val && $lang=='ru')
										{
											...
											show(array("������� ����� UTF ��� mbstring"),$utf);

											/*
											$text0 = $utf ? "\xd0\xa2\xd0\xb5\xd0\xa1\xd1\x82" : '����';
											$text1 = $utf ? "\xd1\x82\xd0\xb5\xd1\x81\xd1\x82" : '����';

											$res = strtolower($text0);
											$val = $res==$text1 || $res==$text0;
											show(array("������ ������� strtolower",'����������� ������� strtolower ��� ������� ����. ����� ����� �� ���� ��������� ��������������: "����" -&gt; "����" ������ "����"',1),$val,!$val);


											$l = strlen("\xd0\xa2");
											$val = $utf && $l==1 || !$utf && $l==2;
											show(array("������ ������� strlen",'',1),$val,!$val);
											*/
										}
